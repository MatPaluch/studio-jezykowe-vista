    ...
    <section className={`container ${style.secLang}`} id='language'>
      <div className={style.headingContent}>
        ...
        <p className='textRegular'>
          Nasza szkoła językowa oferuje kursy z języka angielskiego, niemieckiego oraz
          hiszpańskiego. Każdy z tych języków otwiera drzwi do nowych możliwości i kultur.
        </p>
      </div>
      <ul className={style.cardList}>
        <li>
          <img src={en} alt='english_icon' />
          <h3 className='header3_5'>Język angielski – klucz do świata</h3>
          <p className='textRegular'>
            Angielski to najpopularniejszy język na świecie, niezbędny w komunikacji
            międzynarodowej.
          </p>
        </li>
        <li>
          <img src={de} alt='german_icon' />
        ...
        <li>
          <img src={es} alt='spain_icon' />
          <h3 className='header3_5'>Język hiszpański – język pasji i kultury</h3>
          <p className='textRegular'>
